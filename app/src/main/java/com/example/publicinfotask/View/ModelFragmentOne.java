...
public class ModelFragmentOne extends Fragment implements InterfaceDetailSection {
    ...
    public void onClick(int position) {
        ...
        getActivity().getSupportFragmentManager().beginTransaction().add(R.id.IdBaseFrame,detail,"one").addToBackStack("one").commit();
    }
}
