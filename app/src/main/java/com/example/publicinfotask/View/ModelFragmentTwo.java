...
public class ModelFragmentTwo extends Fragment implements InterfaceDetailSection {
    ...
    public void onClick(int position) {
        ...
        getActivity().getSupportFragmentManager().beginTransaction().add(R.id.IdBaseFrame,detail,"two").addToBackStack("two").commit();
    }
}
